...
export default function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-[#0f0f0f]">
      {/* Sidebar */}
      <aside 
        className={`flex flex-col border-r border-gray-800 bg-[#1a1a1a] transition-all duration-200 ${
          collapsed ? "w-12" : "w-60"
        }`}
      >
        {/* Header */}
        <div className="flex h-12 items-center justify-between border-b border-gray-800 px-3">
          {!collapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">Deficit Hub</span>
            </div>
          )}
          <button
        ...
        <div className="border-t border-gray-800 p-2">
          <button className={`flex items-center gap-3 px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 hover:text-white rounded w-full ${collapsed ? "justify-center" : ""}`}>
            <Icons.settings />
